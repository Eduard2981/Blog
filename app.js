...
mongoose.connect(
  "mongodb+srv://Eduard:" +
  secret.password() +
  "@football-blog.ztmi36k.mongodb.net/?retryWrites=true&w=majority"
);
...
const articleData = {
  title: "ERROR 404",
  imgUrl: "https://img.freepik.com/premium-vector/internet-connection-problem-concept-illustration-404-found-error-page-isolated-white-background-funny-gray-cat-isolated-vector-illustrations_450656-204.jpg?w=2000",
...
app.get("/posts", function (req, res, next) {
  ...
  Post.find()
    .select("_id title imgUrl description paragraph blogDate request")
    .exec()
    .then(doc => {
...
app.get("/test", function (req, res) {
  Post.find()
    .select('_id title imgUrl description paragraph blogDate')
    .exec()
    .then(function (docs) {
      const response = {
        count: docs.length,
